...
// select the divs corresponding to the tabs
    ...
    let tab1AreaOutText = document.getElementById('tab1-area-out')
    let tab2AreaOutText = document.getElementById('tab2-area-out')
    let tab3AreaOutText = document.getElementById('tab3-area-out')

    // clear input/output fields
    inTab1.value = '';
    inTab2.value = '';
    inTab3.value = '';
    tab1AreaOutText.innerHTML = `<div class="mt-3 sm:text-base text-sm" id="tab1-area-out"></div>`
    tab1AreaOutText.classList.add("invisible");
    tab2AreaOutText.innerHTML = `<div class="mt-3 sm:text-base text-sm" id="tab2-area-out"></div>`
    tab2AreaOutText.classList.add("invisible");
    tab3AreaOutText.innerHTML = `<div class="mt-3 sm:text-base text-sm" id="tab3-area-out"></div>`
    tab3AreaOutText.classList.add("invisible");
